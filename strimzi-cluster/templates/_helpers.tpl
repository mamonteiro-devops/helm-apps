...
{{ include "strimzi-cluster.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "strimzi-cluster.selectorLabels" -}}
...
*/}}
{{- define "strimzi-cluster.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "strimzi-cluster.fullname" .) .Values.serviceAccount.name }}
{{- else }}
